...
// Dynamic background-Image
    ...
    //     temperatureone.innerHTML = `${Math.round(weather.list[i].main.temp)}&deg;C`;
    
    //     let minMaxTempone = document.getElementById('min-maxone');
    //     minMaxTempone.innerHTML = `min: ${Math.round(weather.list[i].main.temp_min)}&deg;C | max: ${Math.round(weather.list[i].main.temp_min)}&deg;C`;
    
    //     let weatherTypeone = document.getElementById('weatherone');
    //     weatherTypeone.innerText =  `${weather.list[i].weather[0].main}`;
     
    //     let dateone = document.getElementById('dateone');
    //     dateone.innerHTML = `${weather.list[i].dt_txt}`;


    //     // Show icon image from api 
    
    // let iconone = document.getElementById('imgone').src = "http://openweathermap.org/img/wn/".concat(weather.list[i].weather[0].icon).concat("@2x.png");
